...
public class MainScreenADM extends MainScreen {
    private ADMControl myControl;
    public MainScreenADM() {
        myControl = new ADMControl();
    }
    ...
    public void help() {
        ...
        System.out.println("|14- pesquisar usuario            |");
        ...
        while (flag) {
            ...
            switch (answerClient) {
                ...
                case "14":
                    ...
                    cpf = in.nextLine();
                    System.out.println(myControl.searchUser(cpf));
                    break;
                case "15":
                    flag = false;
                    Main.flag = false;
